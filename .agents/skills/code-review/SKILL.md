...
- Are data models cleanly typed in `packages/types` or `@/src/types/` without inline `any`?
...
### 4. Wireframe & Visual Design Fidelity (`GSRTC-WIREFRAMES.md`)
- Does the UI strictly match the visual mockups and layout structure defined in `GSRTC-WIREFRAMES.md`?
...
### 5. Accessibility & Anti-Pattern Prevention (`enhancements.md`)
